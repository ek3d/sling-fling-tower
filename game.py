...
class MultiFling:
    ...
    def draw(self, camera_position):
        ...
        if self.activated:
            draw_text((window_center[0], window.height - 30), 'Multi-Fling', 24, GREEN, center = True)
...
class Feather:
    ...
    def draw(self, camera_position):
        ...
        if self.activated:
            draw_text((window_center[0] - 100, window.height - 30), 'Feather', 24, PURPLE, center = False)
...
class Game():
    def __init__(self):
        ...
        self.platforms = [
            ...
            pygame.Rect((window.width - 5, window_center[1] - 200), (10, 400)),
